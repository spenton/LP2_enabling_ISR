...
\begin{flushright}
% Put the TIR number here (and also below)
...
FENA4, was the last of a series of programs allowing COS to be moved to its second lifetime position (LP2). These other programs were;
\begin{itemize}
